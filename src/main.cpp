...
unsigned int nStakeMinAge = 8 * nOneHour; // 8 hours as zero time weight
unsigned int nStakeMaxAge = 60 * 24 * nOneHour; // 60 days as full weight
...
const string strMessageMagic = "HHCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HHCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // HHCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HHCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1496689621;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1311022; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb6, 0xf8, 0xe2, 0xe5 };
