...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("HHC");
    case mBTC: return QString("mHHC");
    case uBTC: return QString::fromUtf8("μHHC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("HHCoins"));
    case mBTC: return QString(QObject::tr("Milli-HHCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-HHCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
